...
return [
    'customer'   => [
        ...
        'address1_required'  => 'required|string|max:200',
        'address1_null'      => 'nullable|string|max:200',
        'address2_required'  => 'required|string|max:200',
        'address2_null'      => 'nullable|string|max:200',
        ...
        'estado_required'   => 'required|string|min:1',
        'municipio_required'   => 'required|string|min:1',
        'parroquia_required'   => 'required|string|min:1',
        'country_null'       => 'nullable|string|min:2',
        'postcode_required'  => 'required|min:4',
        'postcode_null'      => 'nullable|min:4',
