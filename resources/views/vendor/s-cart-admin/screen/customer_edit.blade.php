...
@section('main')
                ...
                <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal"
                    ...
                    <div class="card-body">
                        <div class="fields-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            ...
                                            <select required type="text"
                                                ...
                                                <option value="N"
                                                    {{ $customer['natural_jurídica'] == 'N' ? 'selected' : '' }}>Natural
                                                </option>
                                                <option value="J"
                                                    {{ $customer['natural_jurídica'] == 'J' ? 'selected' : '' }}>Juridica
                                                </option>
                            ...
                            @if (sc_config_admin('customer_razon_social'))
                                <div
                                    class="form-group row {{ $errors->has('razon_social') ? ' text-red' : '' }} oculta_razon_social">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            ...
                                            <input disabled="true" id="razon_social" placeholder="Razon social"
                                                type="text" class="form-control" name="razon_social"
                            ...
                            @if (sc_config('customer_nacionalidad'))
                                <div class="form-group row{{ $errors->has('nacionalidad') ? ' has-error' : '' }}">
                                    <label for="first_name" class="col-sm-2 col-form-label"> Nacionalidad</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                            ...
                                            <select type="text"
                                                ...
                                                <option value="V" {{ $pieces[0] == 'V' ? 'selected' : '' }}>
                                                    Venezolano(a)</option>
                                                <option value="E" {{ $pieces[0] == 'E' ? 'selected' : '' }}>
                                                    Extranjero(a)</option>
                            ...
                            @if (sc_config('customer_estado_civil'))
                                <div class="form-group row{{ $errors->has('estado_civil') ? ' has-error' : '' }}">
                                    <label for="first_name" class="col-sm-2 col-form-label"> Estado civil</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                            ...
                                            <select type="text"
                                                ...
                                                <option value="SOLTERO(a)"
                                                    {{ $customer['estado_civil'] == 'SOLTERO(a)' ? 'selected' : '' }}>
                                                    Soltero(a)</option>
                                                <option value="CASADO(a)"
                                                    {{ $customer['estado_civil'] == 'CASADO(a)' ? 'selected' : '' }}>
                                                    Casado(a)</option>
                            ...
                            @if (sc_config_admin('customer_lastname'))
                                ...
                                <div class="form-group row {{ $errors->has('cedula') ? ' text-red' : '' }}">
                                    <label for="cedula" class="col-sm-2 col-form-label">Cedulas</label>
                                ...
                                <div class="form-group row {{ $errors->has('first_name_kana') ? ' text-red' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            ...
                                            <input id="first_name_kana" type="text" class="form-control"
                                ...
                                <div class="form-group row {{ $errors->has('last_name_kana') ? ' text-red' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            ...
                                            <input id="last_name_kana" type="text" class="form-control"
                                                name="last_name_kana"
                            ...
                            <div class="form-group row {{ $errors->has('address1') ? ' text-red' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input max="200" id="address1" type="text" class="form-control"
                                            name="address1" value="{{ old('address1', $customer['address1'] ?? '') }}">
                                    </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="birthday" class="form-control date_time"
                                                placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" name="birthday"
                            ...
                            <div class="form-group  row {{ $errors->has('password') ? ' text-red' : '' }}">
                                <label for="password"
                                    class="col-sm-2  col-form-label">{{ sc_language_render('customer.password') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                            ...
                            <div class="form-group  row {{ $errors->has('estado') ? ' text-red' : '' }}">
                                <label for="estado"
                                    class="col-sm-2  col-form-label">{{ sc_language_render('customer.estado') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                            ...
                            <div class="form-group  row {{ $errors->has('estado') ? ' text-red' : '' }}">
                                <label for="municipio"
                                    class="col-sm-2  col-form-label">{{ sc_language_render('customer.municipio') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                            ...
                            <div class="form-group  row {{ $errors->has('cod_parroquia') ? ' text-red' : '' }}">
                                <label for="cod_parroquia"
                                    class="col-sm-2  col-form-label">{{ sc_language_render('customer.parroquia') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                        ...
                                        <div class="input-group">
                                            <select required type="text"
                                                ...
                                                <option value="facebook"
                                                    {{ $customer['nos_conocio'] == 'facebook' ? 'selected' : '' }}>Facebook
                                                </option>
                                                <option value="instagram"
                                                    {{ $customer['nos_conocio'] == 'instagram' ? 'selected' : '' }}>
                                                    instagram</option>
                            ...
                            @if ($customer['provider'])
                                <div class="form-group  row">
                                    <label for="status"
                                        class="col-sm-2  col-form-label">{{ sc_language_render('customer.admin.provider') }}</label>
                                    <div class="col-sm-8">
                                        {{ $customer['provider'] }}
                                    </div>
                                </div>
                            ...
                            @if (isset($customFields) && count($customFields))
                                ...
                                <label>{{ sc_language_render('admin.custom_field.title') }} (<a target=_new
                                        href="{{ sc_route_admin('admin_custom_field.index') }}"><i class="fa fa-link"
                                ...
                                @foreach ($customFields as $keyField => $field)
                                    ...
                                    @endphp
                                    <div
                                        class="form-group row kind   {{ $errors->has('fields.' . $field->code) ? ' text-red' : '' }}">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            @else
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="field_{{ $field->code }}"
                                                        name="fields[{{ $field->code }}]"
                    ...
                    <div class="card-footer row ">
                        ...
                        <div class="col-12 col-md-3  mt-2 ">
                            <div class="btn-group ">
                                <a href="{{ sc_route_admin('admin_customer.document', ['id' => $customer['id'] ? $customer['id'] : 'not-found-id']) }}"
                                    class="btn btn-info">Ver Documentos adjuntos</a>
                            </div>
                        </div>
                        <div class=" col-12 col-md-3  mt-2">
                        ...
                        <div class="row ">
                            <div class="form-group   col-12 col-md-6 mt-3">
                                ...
                                <div class=" col-12 col-md-12 mb-3">
                                    <div class="input-group">
                                        <input type="text" id="nombre_ref" name="nombre_ref" value=""
                                ...
                                <div class="col-12 col-md-12 mb-3">
                                    <div class="input-group">
                                        <input required type="text" id="apellido_ref" name="apellido_ref"
                                            value="" class="form-control " placeholder="apellido" />
                                    </div>
                                </div>
                                <div class="col-12 col-md-12 mb-3">
                                    <div class="input-group">
                                        <input required type="text" id="cedula_ref" name="cedula_ref" value=""
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="input-group">
                                        <input required type="number" id="telefono_ref" name="telefono_ref"
                                            value="" class="form-control" placeholder="Telefono" />
                                    </div>
                                </div>
                                <div class="col-md-12 ">
                                    <div class="input-group">
                                        <input required type="text" id="parentesco" name="parentesco" value=""
                                            class="form-control" placeholder="parentesco" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12  mb-3 ">
                                    <div class="input-group">
                                        <input required type="text" id="observacionr" name="observacionr"
                                            value="" class="form-control" placeholder="Nota" />
                                    </div>
                                </div>
                                ...
                                <table class="table table-responsive">
                                    ...
                                    @foreach ($referencia as $ref)
                                        <tbody>
                                            ...
                                            <td> <input type="text"
                                                    class="form-control editar_referencia{{ $ref->id }}"
                                                    value=" {{ $ref->nombre_ref }}" id="nombre{{ $ref->id }}"
                                                    readonly> </td>
                                            <td>
                                                <input type="text"
                                                    class="form-control editar_referencia{{ $ref->id }}"
                                                    value=" {{ $ref->apellido_ref }}" id="apellido{{ $ref->id }}"
                                                    readonly>
                                            </td>
                                            <td>
                                                <input type="text"
                                                    class="form-control editar_referencia{{ $ref->id }}"
                                                    value=" {{ $ref->cedula_ref }}" id="cedula{{ $ref->id }}"
                                                    readonly>
                                            ...
                                            <td>
                                                ...
                                                <input type="text"
                                                    class="form-control editar_referencia{{ $ref->id }}"
                                                    value=" {{ $ref->telefono }}" id="telefono{{ $ref->id }}"
                                                    readonly>
                                            ...
                                            <td>
                                                ...
                                                <input type="text"
                                                    class="form-control editar_referencia{{ $ref->id }}"
                                                    value=" {{ $ref->parentesco }}" id="parentesco{{ $ref->id }}"
                                                    readonly>
                                            ...
                                            <td>
                                                ...
                                                <input type="text"
                                                    class="form-control editar_referencia{{ $ref->id }}"
                                                    value=" {{ $ref->nota }}" id="nota{{ $ref->id }}"
                                                    readonly>

                                            </td>
                                            <td>
                                                <span onclick="modificar_referencia('{!! $ref->id !!}',this);"
                                                    data-accion="editar" title="Editar"
                                                    class="btn btn-flat btn-sm btn-info"><i
                                                        class=" editar{!! $ref->id !!} fas fa-edit"></i></span>
                                                <span onclick="deleteItem('{!! $ref->id !!}');" title="Borrar"
    ...
    @push('scripts')
        <script>
            ...
            function modificar_referencia(id, obj) {


                let accion = $(obj).attr('data-accion');
                if (accion == 'editar') {
                    $(".editar_referencia" + id).attr('readonly', false); 
                     $(obj).attr('data-accion', 'guardar');
                    
                    $('.editar'+id).removeClass('fa-edit')
                    $('.editar'+id).addClass('fa-save')
                } else {
                    $(".editar_referencia" + id).attr('readonly', true); 
                    $(obj).attr('data-accion', 'editar');
                    $('.editar'+id).addClass('fa-edit')
                    $('.editar'+id).removeClass('fa-save')
                    guardar_edit_referencia(id)
                }
            ...
            function guardar_edit_referencia(id)
                {
                let nombre_ref = $('#nombre'+id).val()
                let apellido_ref = $('#apellido'+id).val()
                let telefono_ref = $('#telefono'+id).val()
                let Cedula_ref = $('#cedula'+id).val()
                let parentesco = $('#parentesco'+id).val()
