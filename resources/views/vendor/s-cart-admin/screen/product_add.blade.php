...
@section('main')
                ...
                <div class="card-header with-border">
                    ...
                    <div class="card-tools">
                        <div class="btn-group float-right mr-5">
                            <a target=_new href="{{ sc_route_admin('admin_product.index') }}"
                    ...
                    <div id="main-add" class="card-body">
                        ...
                        @foreach ($languages as $code => $language)
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div
                                        class="form-group row kind  {{ $errors->has('descriptions.' . $code . '.content') ? ' text-red' : '' }}">
                        ...
                        @if (sc_config_admin('product_brand'))
                            ...
                            <div class="form-group row kind   {{ $errors->has('brand_id') ? ' text-red' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <select class="form-control input-sm brand_id select2" name="brand_id">
                                            <option value=""></option>
                                            @foreach ($brands as $k => $v)
                                                <option value="{{ $k }}"
                                                    {{ old('brand_id') == $k ? 'selected' : '' }}>{{ $v->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <div class="input-group-append">
                        ...
                        @if (sc_config_admin('product_supplier'))
                            ...
                            <div class="form-group row kind   {{ $errors->has('supplier_id') ? ' text-red' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <select class="form-control input-sm supplier_id select2" name="supplier_id">
                                            <option value=""></option>
                                            @foreach ($suppliers as $k => $v)
                                                <option value="{{ $k }}"
                                                    {{ old('supplier_id') == $k ? 'selected' : '' }}>{{ $v->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <div class="input-group-append">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" style="width: 100px;" id="cost"
                                            ...
                                            class="form-control input-sm cost" placeholder="" />
                                    </div>
                                    @if ($errors->has('cost'))
                                        <span class="form-text">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" style="width: 100px;" id="monto_inicial"
                                        name="monto_inicial" value="{!! old('monto_inicial',0) !!}"
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" style="width: 100px;" id="nro_coutas"
                                        name="nro_coutas" value="{!! old('nro_coutas') ?? 0 !!}"
                                        class="form-control input-sm price" placeholder="" />
                                </div>
                                ...
                                @endif
                                <span class="form-text">
                                    <i class="fa fa-info-circle"></i> nro de cuotas del producto
                                </span> 
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" style="width: 100px;" id="cuotas_inmediatas"
                                        name="cuotas_inmediatas" value="{!! old('cuotas_inmediatas') ?? 0 !!}"
                                        class="form-control input-sm price" placeholder="" />
                                </div>
                        ...
                        <div class="form-group row kind   {{ $errors->has('monto_cuota_entrega') ? ' text-red' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" style="width: 100px;" id="cuotas_inmediatas"
                                        name="monto_cuota_entrega" value="{!! old('monto_cuota_entrega') ?? 0 !!}"
                                        class="form-control input-sm price" placeholder="" />
                                </div>
                        ...
                        <div class="form-group row kind   {{ $errors->has('modalidad_pago') ? ' text-red' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <select class="form-control input-sm modalidad_pago select2" name="modalidad_pago">
                                        @foreach ($modalidad_pago as $k => $v)
                                            <option value="{{ $v->id }}"
                                                {{ old('modalidad_pago') == $k ? 'selected' : '' }}>{{ $v->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        @if (sc_config_admin('product_tax'))
                            ...
                            <div class="form-group row kind   {{ $errors->has('tax_id') ? ' text-red' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <select class="form-control input-sm tax_id select2" name="tax_id">
                                            <option value="0" {{ old('tax_id') == 0 ? 'selected' : '' }}>
                                                {{ sc_language_render('admin.tax.non_tax') }}</option>
                                            <option value="auto" {{ old('tax_id') == 'auto' ? 'selected' : '' }}>
                                                {{ sc_language_render('admin.tax.auto') }}</option>
                                            @foreach ($taxs as $k => $v)
                                                <option value="{{ $k }}"
                                                    {{ old('tax_id') == $k ? 'selected' : '' }}>{{ $v->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <div class="input-group-append">
                                        ...
                                        <div class="price_promotion">
                                            <div class="input-group">
                                                ...
                                                <input type="number" step="0.01" style="width: 100px;"
                                                    ...
                                                    value="{!! old('price_promotion') ?? 0 !!}" class="form-control input-sm price"
                                                    placeholder="" />
                        ...
                        @if (sc_config_admin('product_weight'))
                            ...
                            <div class="form-group row kind    {{ $errors->has('weight_class') ? ' text-red' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <select class="form-control input-sm weight_class select2" name="weight_class">
                                            <option value="">
                        ...
                        <div class="input-group-append">
                            <a target=_new href="{{ sc_route_admin('admin_weight_unit.index') }}" class="btn  btn-flat"
                                title="New">
                                <i class="fa fa-plus" title="{{ sc_language_render('action.add') }}"></i>
                            </a>
                        </div>
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    ...
                    <input type="number" step="0.01" style="width: 100px;" id="weight" name="weight"
                        value="{!! old('weight', 0) !!}" class="form-control input-sm weight" placeholder="" />
                </div>
        ...
        <div class="col-sm-8">
            <div class="input-group">
                ...
                <input type="number" step="0.01" style="width: 100px;" id="length" name="length"
                    value="{!! old('length', 0) !!}" class="form-control input-sm length" placeholder="" />
            </div>
        ...
        <div class="col-sm-8">
            <div class="input-group">
                ...
                <input type="number" step="0.01" style="width: 100px;" id="height" name="height"
                    value="{!! old('height', 0) !!}" class="form-control input-sm height" placeholder="" />
            </div>
        ...
        <div class="col-sm-8">
            <div class="input-group">
                ...
                <input type="number" step="0.01" style="width: 100px;" id="width" name="width"
                    value="{!! old('width', 0) !!}" class="form-control input-sm width" placeholder="" />
            </div>
            @if ($errors->has('width'))
                <span class="form-text">
    ...
    @if (sc_config_admin('product_property'))
        ...
        <div class="form-group row kind   {{ $errors->has('property') ? ' text-red' : '' }}">
            ...
            <div class="col-sm-8">
                ...
                @endif
                <div style="margin-top: 10px; {{ old('property') != SC_PROPERTY_DOWNLOAD ? 'display:none' : '' }}"
                    id="download_path">
                    <input type="text" name="download_path" value="{{ old('download_path') }}"
                        class="form-control input-sm" placeholder="{{ sc_language_render('product.download_path') }}" />
                </div>
            </div>
        </div>
        {{-- //property --}}
    ...
    @if (sc_config_admin('product_available'))
        {{-- date available --}}
        <div class="form-group row kind   {{ $errors->has('date_available') ? ' text-red' : '' }}">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    ...
                    <input type="text" data-date-format="yyyy-mm-dd" style="width: 100px;" id="date_available"
                        name="date_available" value="{!! old('date_available') !!}"
        ...
        <div class="col-sm-8">
            <div class="input-group">
                ...
                <input type="number" style="width: 100px;" id="minimum" name="minimum"
                    value="{!! old('minimum') ?? 0 !!}" class="form-control input-sm minimum" placeholder="" />
            </div>
        ...
        <div class="col-sm-8">
            <div class="input-group">
                ...
                <input type="number" style="width: 100px;" id="sort" name="sort"
                    value="{!! old('sort') ?? 0 !!}" class="form-control input-sm sort" placeholder="" />
            </div>
            @if ($errors->has('sort'))
                <span class="form-text">
    ...
    <div class="form-group row ">
        ...
        <div class="col-sm-8">
            <input class="checkbox" type="checkbox" name="precio_de_cuota"
                {{ old('precio_de_cuota') ? 'checked' : 'checked' }} >
                <span class="form-text">
                    <i class="fa fa-info-circle"></i> Mostra en la tienda el precio de la cuota o el precio real
                </span>
        </div>
    </div>
    {{-- //precio_de_cuota --}}
    ...
    @if (sc_config_admin('product_attribute'))
        ...
        @if (!empty($attributeGroup))
            ...
            <div class="form-group kind  row">
                <div class="col-sm-2">
                    <label>{{ sc_language_render('product.attribute') }} (<a target=_new
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td colspan="3"><br><button type="button"
                                        class="btn btn-flat btn-success add_attribute" data-id="{{ $attGroupId }}">
                                        <i class="fa fa-plus" aria-hidden="true"></i>
                    ...
                    @elseif($field->option == 'select')
                        @if ($default)
                            <select class="form-control input-sm {{ $field->code }}" style="width: 100%;"
                                ...
                                @foreach ($default as $key => $name)
                                    <option value="{{ $key }}"
                                        {{ old('fields.' . $field->code) == $key ? 'selected' : '' }}>{{ $name }}
                                    </option>
                                @endforeach
                            </select>
                        @endif
    ...
    <script type="text/javascript">
        ...
        $('#add_sub_image').click(function(event) {
            ...
            $(this).before(
                ...
                '" name="sub_image[]" value="" class="form-control input-sm sub_image" placeholder=""  />' +
                '  <div class="input-group-append">' +
