      ...
      <div class="card-header">
        ...
        @if ($layout == 'edit')
          <div class="btn-group float-right" style="margin-right: 5px">
              <a href="{{ sc_route_admin('tipo_tarjetas') }}" class="btn  btn-flat btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs"> {{ sc_language_render('admin.back_list') }}</span></a>
          </div>
        @endif
      </div>
      <!-- /.card-header -->
          ...
          <div class="form-group row {{ $errors->has('name') ? ' text-red' : '' }}">
            ...
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
                ...
                <input type="text" id="name" name="name" value="{{ old()?old('name'):$order_status['tipo']??'' }}" class="form-control name {{ $errors->has('tipo') ? ' is-invalid' : '' }}">
              </div>

              <div class="form-group">
                <label for="limite">Limite</label>
                <input type="number" id="limite" name="limite" value="{{ old()?old('limite'):$order_status['monto_limite']??'0' }}" class="form-control name {{ $errors->has('limite') ? ' is-invalid' : '' }}">
