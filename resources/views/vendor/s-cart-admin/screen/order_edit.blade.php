                                    ...
                                    @if ($estatus_user == 'Riesgo ' || $estatus_user == 'Administrator')
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="opciones">
                                                <option value="">Descarga de documentos</option>
                                                @if ($order->total > 0 && !empty($convenio))
                                                    <option value="{{ route('downloadJuradada', ['id' => $order->id]) }}"
                                                        target="_blank">Declaración jurada</option>
                                                @endif
                                                ...
                                                @if ($order->total > 0 && !empty($convenio))
                                                    <option value="{{ route('downloadPdf', ['id' => $order->id]) }}"
                                                        target="_blank">Descargar convenio</option>
                                                @endif

                                                @if ($order->total > 0 && !empty($convenio))
                                                    <option
                                                        value="{{ route('editar_convenio_cliente', ['id' => $order->id]) }}"
                                                        target="_blank">Editar convenio</option>
                                                @endif

                                                @if ($order->total > 0 && $order->modalidad_de_compra >= 1 && empty($convenio))
                                                    <option value="{{ route('borrador_pdf', ['id' => $order->id]) }}"
                                                        target="_blank">Borrador Convenio</option>
                                                @endif
                                                @if ($order->total > 0 && $order->modalidad_de_compra >= 1 && empty($convenio))
                                                    <option
                                                        value="{{ sc_route_admin('ficha_pedido', ['order_id' => $order->id]) }}"
                                                        target="_blank">Descargar exp</option>
                                                @endif


                                                <option
                                                    value="{{ sc_route_admin('admin_order.invoice', ['order_id' => $order->id]) }}"
                                                    target="_blank">{{ sc_language_render('order.invoice') }}</option>

                                                @if ($order->modalidad_de_compra == 3)
                                                    <option
                                                        value="{{ sc_route_admin('propuesta', ['order_id' => $order->id]) }}"
                                                        target="_blank">Descargar propuesta</option>
                                                @endif
                                            </select>
                                        </div>
                                    @endif
                        ...
                        @if ($order->modalidad_de_compra == 1 || $order->modalidad_de_compra == 0 || $order->modalidad_de_compra == 2)
                            <div class="accordion" id="accordionExample">
                                                    ...
                                                    <table class="table table-bordered">
                                                        @foreach ($dataTotal as $element)
                                                            @if ($element['code'] == 'subtotal')
                                                                <tr>
                                                                    <td class="td-title-normal">{!! $element['title'] !!}:
                                                                    </td>
                                                                    <td style="text-align:right"
                                                                        class="data-{{ $element['code'] }}">
                                                            ...
                                                            @if ($element['code'] == 'shipping')
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align:right"><a href="#"
                                                                            class="updatePrice data-{{ $element['code'] }}"
                                                                            data-name="{{ $element['code'] }}"
                                                                            data-type="text"
                                                                            data-pk="{{ $element['id'] }}"
                                                                            data-url="{{ route('admin_order.update') }}"
                                                                            data-title="{{ sc_language_render('order.totals.shipping') }}">{{ $element['value'] }}</a>
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                            @if ($element['code'] == 'discount')
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align:right"><a href="#"
                                                                            ...
                                                                            data-pk="{{ $element['id'] }}"
                                                                            data-url="{{ route('admin_order.update') }}"
                                                                            data-title="{{ sc_language_render('order.totals.discount') }}">{{ $element['value'] }}</a>
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                            @if ($element['code'] == 'other_fee')
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align:right"><a href="#"
                                                                            ...
                                                                            data-pk="{{ $element['id'] }}"
                                                                            data-url="{{ route('admin_order.update') }}"
                                                                            data-title="{{ config('cart.process.other_fee.title') }}">{{ $element['value'] }}</a>
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                            ...
                                                            @if ($element['code'] == 'received')
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align:right"><a href="#"
                                                                            ...
                                                                            data-pk="{{ $element['id'] }}"
                                                                            data-url="{{ route('admin_order.update') }}"
                                                                            data-title="{{ sc_language_render('order.totals.received') }}">{{ $element['value'] }}</a>
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                        @endforeach
                                                        ...
                                                        <tr {!! $style !!} class="data-balance">
                                                            ...
                                                            <td style="text-align:right">
                                                                {{ $order->balance === null ? sc_currency_format($order->total) : sc_currency_format($order->balance) }}
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseThree" class="collapse show" aria-labelledby="headingevaluacion"
                                        data-parent="#accordionExample">
                                        <div class="card-body">
                                            {{-- evaluacion --}}
                                            <div class="col-sm-12">
                                                    ...
                                                    @if ($order->modalidad_de_compra >= 1)
                                                        <table class="table table-hover box-body text-wrap table-bordered">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="#" class="updateInfo"
                                                                        data-name="nota_evaluacion_comercial "
                                                                        data-type="textarea"
                                                                        data-pk="{{ $order->id }}"
                                                                        data-url="{{ route('admin_order.update') }}"
                                                                        data-title="Nota">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="#" class="updateInfo"
                                                                        data-name="evaluacion_comercial "
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="#" class="updateInfo"
                                                                        data-name="confiabilidad " data-type="number"
                                                                        data-pk="{{ $order->id }}"
                                                                        data-url="{{ route('admin_order.update') }}"
                                                            ...
                                                            <tr>
                                                                <td class="td-title"><span>Evaluación financiera</span>
                                                                </td>
                                                                <td>
                                                                    <a href="#" class="updateInfo"
                                                                        data-name="nota_evaluacion_financiera "
                                                                        data-type="textarea"
                                                                        data-pk="{{ $order->id }}"
                                                                        data-url="{{ route('admin_order.update') }}"
                                                                        data-title="Nota F">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="#" class="updateInfo"
                                                                        data-name="evaluacion_financiera "
                                                                        data-type="number" data-pk="{{ $order->id }}"
                                                                        data-url="{{ route('admin_order.update') }}"
                                                                        data-title="Nota">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="#" class="updateInfo"
                                                                        data-name="confiabilidad2 " data-type="number"
                                                                        data-pk="{{ $order->id }}"
                                                                        data-url="{{ route('admin_order.update') }}"
                                                                        data-title="Confiabilidad">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="#" class="updateInfo"
                                                                        data-name="nota_evaluacion_legal"
                                                                        data-type="textarea"
                                                                        data-pk="{{ $order->id }}"
                                                                        data-url="{{ route('admin_order.update') }}"
                                                                        data-title="Nota">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="#" class="updateInfo"
                                                                        data-name="evaluacion_legal" data-type="number"
                                                                        data-pk="{{ $order->id }}"
                                                                        data-url="{{ route('admin_order.update') }}"
                                                                        data-title="Confiabilidad">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="#" class="updateInfo"
                                                                        data-name="confiabilidad3 " data-type="number"
                                                                        data-pk="{{ $order->id }}"
                                                                        data-url="{{ route('admin_order.update') }}"
                                                                        data-title="Confiabilidad">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <select id="decision_final"
                                                                        onChange="selectProduct2($(this));"
                                                                        class="decision_final form-control select2 "
                                                                        name="decision_final">
                                                                        <option value="0"
                                                                            {{ $order['decision_final'] == 0 ? 'selected' : '' }}>
                                                                            Pendiente </option>
                                                                        <option value="1"
                                                                            {{ $order['decision_final'] == 1 ? 'selected' : '' }}>
                                                                            Negado </option>
                                                                        <option value="2"
                                                                            {{ $order['decision_final'] == 2 ? 'selected' : '' }}>
                                                                            Aprobado </option>
                                                                        <option value="3"
                                                                            {{ $order['decision_final'] == 3 ? 'selected' : '' }}>
                                                                            Diferido </option>
                                                                        <option value="3"
                                                                            {{ $order['decision_final'] > 3 ? 'selected' : '' }}>
                                                                            Otro </option>
                                                    ...
                                                    @foreach ($historial_pagos as $historial)
                                                        <tr>
                                                            ...
                                                            <td><span class="item_21_sku">{{ $historial->importe_couta }}
                                                                    $</span></td>
                                                            <td><span
                                                                    class="item_21_sku">{{ $historial->importe_pagado }}</span>
                                                            </td>
                                                            @php
                                                                $tasa_cambio = $historial->tasa_cambio ? $historial->tasa_cambio : 1;
                                                                
                                                            @endphp
                                                            <td><span class="item_21_sku">{{ $historial->moneda }}</span>
                                                            </td>

                                                            <td>
                                                                @if ($historial->moneda == 'USD')
                                                                    <span class="item_21_sku">{!! round($historial->importe_pagado * $tasa_cambio, 2) !!}
                                                                        bs</span>
                                                                @else
                                                                    <span class="item_21_sku">{!! round($historial->importe_pagado / $tasa_cambio, 2) !!}
                                                                        $</span>
                                                            ...
                                                            <td><span class="item_21_sku">{!! fecha_europea($historial->fecha_venciento) !!}</span>
                                                            </td>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                        ...
                                        <div class="card-body">
                                            <!-- /.card-header -->
                                            <h3 class="card-title">{{ sc_language_render('order.admin.order_history') }}
                                            </h3>
                                                ...
                                                <div class="table-responsive">
                                                    @if (count($order->history))
                                                        <table class="table m-0" id="history">
                                                            <tr>
                                                                <th>{{ sc_language_render('order.admin.history_staff') }}
                                                                </th>
                                                                <th>{{ sc_language_render('order.admin.history_content') }}
                                                                </th>
                                                                <th>{{ sc_language_render('order.admin.history_time') }}
                                                                </th>
                                                            </tr>
                                                            @foreach ($order->history->sortKeysDesc()->all() as $history)
                                                                <tr>
                                                                    <td>{{ \SCart\Core\Admin\Models\AdminUser::find($history['admin_id'])->name ?? '' }}
                                                                    </td>
                                                                    <td>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                    ...
                                    <form action="{!! sc_route('crear_convenio') !!}" method="POST">
                                        <div id="w-100">
                                            ...
                                            <div name="frmPrestamo" id="frmPrestamo">
                                                <input type="hidden" name="c_producto"
                                                    value="{!! count($order->details) ? $order->details[0]->name : 0 !!} ">
                                                <input type="hidden" name="c_order_id"
                                                    value="{!! $order->id !!} ">

                                                <div class="form-group">
                                                    <label for="monto">Monto: </label>
                                                    <input readonly value="{!! count($order->details) ? $order->details[0]->price : 0 !!}"
                                                        class="form-control   " type="text" name="_monto"
                                                        id="c_monto" placeholder="monto">
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input readonly value="{!! count($order->details) ? $order->details[0]->nro_coutas : 0 !!}"
                                                            class="form-control   " type="text" name="c_nro_coutas"
                                                            id="c_nro_coutas" placeholder="_nro_cuotas">
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input readonly value="0" class="form-control   "
                                                            type="text" name="c_modalidad" id="c_modalidad"
                                                            placeholder="_nro_cuotas">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input value="{!! count($order->details) ? $order->details[0]->nro_coutas : 0 !!}" class="form-control   "
                                                            type="date" name="c_fecha_inicial" id="c_fecha_inicial"
                                                            placeholder="_nro_cuotas">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="monto">Fecha de entrega: </label>
                                                        <input class="form-control   " type="date"
                                                            name="fecha_maxima_entrega" id="fecha_maxima_entrega">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="monto">Inicial $: </label>
                                                        <input readonly value="0" class="form-control   "
                                                            type="text" name="c_inicial" id="c_inicial"
                                                            placeholder="_nro_cuotas">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="nro_convenio">Numero de convenio: </label>
                                                        <input class="form-control   " type="text"
                                                            value="{{ $nro_convenio }}" name="nro_convenio"
                                                            id="nro_convenio" placeholder="numero de convenio ">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                ...
                                                <button type="button" class=" btn btn-info" id="simular"
                                                    onclick="gen_table(true)"> CALCULAR</button>
                                            </div>
                                        </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button id="butto_modal" disabled="true" type="submit"
                                        class="btn btn-primary">Crear Convenio</button>
                                </div>
                                ...
                                <select id="mdivisa" class="form-control" required name="moneda">
                                    @foreach (sc_currency_all() as $moneda)
                                        <option value="{{ $moneda->code }}" {!! $moneda->code == 'USD' ? 'selected' : '' !!}
                                            data-exchange_rate="{{ $moneda->exchange_rate }}"> {{ $moneda->code }}
                                        </option>
                                    @endforeach
                ...
                success: function(returnedData) {
                    ...
                    if (monto > 0) {
                        ...
                        for (i = 1; i <= n2; i++) {
                            ...
                            document.getElementById("tab").innerHTML = document.getElementById("tab")
                                .innerHTML +
                                `
                          <tr>
                              <td>${i}</td>
