 ...
 <div class="row">
    <div class="col-md-12"> 
      <ul class="nav nav-tabs" id="tab_ordenes" role="tablist">
        ...
        <li class="nav-item" role="presentation">
          <a class="nav-link" id="tabevaluaciones-tab" data-toggle="tab" href="#tabevaluaciones" role="tab" aria-controls="tabevaluaciones" aria-selected="false">Evaluaciones</a>
        </li> 
        <li class="nav-item" role="presentation">
        ...
        <li class="nav-item" role="presentation">
          <a class="nav-link" id="tabacciones-tab" data-toggle="tab" href="#tabacciones" role="tab" aria-controls="tabacciones" aria-selected="false">Historial Acciones</a>
        </li> 
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu">
            ...
            <a class="dropdown-item" href="#" onclick="abrir_modal_convenio(event)" >Generar Convenio</a>
      ...
      <div class="tab-content" id="myTabContent">
       ...
       <div class="card">
        ...
        <input type="hidden" name="styleStatusPayment" id="styleStatusPayment" value="{{ json_encode($styleStatusPayment) }}">
