...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{route('create_convenio')}}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row {{ $errors->has('shop_store') ? ' text-red' : '' }}">
                        <label for="shop_store"
                            class="col-sm-2 col-form-label">Seleciona plantilla</label>
                        <div class="col-sm-8">
                            <select class="form-control shop_store select2" name="inicial">
                                <option value="sin_inicial">Sin inicial</option>
                                <option value="con_inicial">Con inicial</option>
