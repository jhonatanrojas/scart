...
@section('main')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="{{ sc_route_admin('admin_product.edit', ['id' => $product['id']]) }}" method="post"
                    accept-charset="UTF-8" class="form-horizontal" id="form-main" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        @foreach ($languages as $code => $language)
                            <div
                                class="card card-{{ $product->kind == 1 ? 'success' : ($product->kind == 2 ? 'danger' : '') }}">
                                <div class="card-header with-border">
                                ...
                                <div class="card-body">
                                    ...
                                    <div
                                        ...
                                        <label for="{{ $code }}__name"
                                            class="col-sm-2 col-form-label">{{ sc_language_render('product.name') }} <span
                                    ...
                                    <div
                                        ...
                                        <label for="{{ $code }}__keyword"
                                            class="col-sm-2 col-form-label">{{ sc_language_render('product.keyword') }}
                                    ...
                                    <div
                                        ...
                                        <label for="{{ $code }}__description"
                                            class="col-sm-2 col-form-label">{{ sc_language_render('product.description') }}
                                            <span class="seo" title="SEO"><i class="fa fa-coffee"
                                                    aria-hidden="true"></i></span></label>
                                        <div class="col-sm-8">
                                ...
                                <div class="input-group">
                                    <select class="form-control category select2" multiple="multiple"
                                        ...
                                        @foreach ($categories as $k => $v)
                                            <option value="{{ $k }}"
                                                {{ count($listCate) && in_array($k, $listCate) ? 'selected' : '' }}>
                                                {{ $v }}
                                            </option>
                                        @endforeach
                                    </select>
                                    <div class="input-group-append">
                                        <a target=_new href="{{ sc_route_admin('admin_category.index') }}"
                            ...
                            <div class="form-group row {{ $errors->has('shop_store') ? ' text-red' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control shop_store select2"
                                        @if (sc_check_multi_store_installed()) multiple="multiple" @endif
                                        data-placeholder="{{ sc_language_render('admin.select_store') }}"
                                        style="width: 100%;" name="shop_store[]">
                                        <option value=""></option>
                                        @foreach (sc_get_list_code_store() as $k => $v)
                                            <option value="{{ $k }}"
                                                {{ count($listStore) && in_array($k, $listStore) ? 'selected' : '' }}>
                                                {{ $v }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group row  {{ $errors->has('image') ? ' text-red' : '' }}">
                            <label for="image"
                                class="col-sm-2 col-form-label">{{ sc_language_render('product.image') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                        ...
                                        @if ($sub_image)
                                            <div class="group-image">
                                                <div class="input-group"><input type="text"
                                                        id="sub_image_{{ $key }}" name="sub_image[]"
                                                        value="{!! $sub_image !!}" class="form-control sub_image"
                                                        placeholder="" /><span class="input-group-btn"><span><a
                        ...
                        <div class="form-group row {{ $errors->has('sku') ? ' text-red' : '' }}">
                            <label for="sku"
                                class="col-sm-2 col-form-label">{{ sc_language_render('product.sku') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                    ...
                                    <input type="text" style="width: 100px;" id="sku" name="sku"
                                        value="{!! old('sku', $product->sku) !!}" class="form-control sku" placeholder="" />
                                </div>
                                @if ($errors->has('sku'))
                                    <span class="form-text">
                            ...
                            <div
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <a target=_new href="{{ sc_route_admin('admin_brand.index') }}"
                                                class="btn  btn-flat" title="New">
                                                <i class="fa fa-plus" title="{{ sc_language_render('action.add') }}"></i>
                                            </a>
                                        </div>
                        ...
                        @if (sc_config_admin('product_supplier') &&
                            ...
                            <div
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <select class="form-control supplier_id select2" name="supplier_id">
                                            <option value=""></option>
                                        ...
                                        <div class="input-group-append">
                                            <a target=_new href="{{ sc_route_admin('admin_supplier.index') }}"
                                                class="btn  btn-flat" title="New">
                                                <i class="fa fa-plus" title="{{ sc_language_render('action.add') }}"></i>
                                            </a>
                                        </div>
                        ...
                        @if (sc_config_admin('product_cost'))
                            ...
                            @if ($product->kind == SC_PRODUCT_SINGLE)
                                <div
                                    class="form-group row kind kind0 kind1  {{ $errors->has('cost') ? ' text-red' : '' }}">
                                    <label for="cost"
                                        class="col-sm-2 col-form-label">{{ sc_language_render('product.cost') }}</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                            </div>
                                            <input type="number" step="0.01" style="width: 100px;" id="cost"
                                                name="cost" value="{!! old('cost', $product->cost) !!}" class="form-control cost"
                                                placeholder="" />
                                        </div>
                                        @if ($errors->has('cost'))
                                            <span class="form-text">
                        ...
                        @if (sc_config_admin('product_price'))
                            @if ($product->kind == SC_PRODUCT_SINGLE || $product->kind == SC_PRODUCT_BUILD)
                                ...
                                <div class="form-group row  {{ $errors->has('price') ? ' text-red' : '' }}">
                                    <label for="price"
                                        class="col-sm-2 col-form-label">{{ sc_language_render('product.price') }}</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                            ...
                                            <input type="number" step="0.01" style="width: 100px;" id="price"
                                                name="price" value="{!! old('price', $product->price) !!}" class="form-control price"
                                                placeholder="" />
                                        </div>
                                        @if ($errors->has('price'))
                                            <span class="form-text">
                            ...
                            <div class="form-group row kind   {{ $errors->has('nro_coutas') ? ' text-red' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" style="width: 100px;" id="nro_coutas"
                                            name="nro_coutas" value="{!! old('nro_coutas', $product->nro_coutas) !!}"
                                            class="form-control input-sm nro_coutas" placeholder="" />
                                    </div>
                            ...
                            <div class="form-group row kind   {{ $errors->has('cuotas_inmediatas') ? ' text-red' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" style="width: 100px;" id="nro_coutas"
                                            name="cuotas_inmediatas" value="{!! old('nro_coutas', $product->cuotas_inmediatas) !!}"
                                            class="form-control input-sm cuotas_inmediatas" placeholder="" />
                                    </div>
                            ...
                            @if (sc_config_admin('product_tax'))
                                @if ($product->kind == SC_PRODUCT_SINGLE || $product->kind == SC_PRODUCT_BUILD)
                                    ...
                                    <div class="form-group row {{ $errors->has('tax_id') ? ' text-red' : '' }}">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <select class="form-control tax_id select2" name="tax_id">
                                                    <option value="0"
                                                        {{ old('tax_id', $product->tax_id) == 0 ? 'selected' : '' }}>
                                                        {{ sc_language_render('admin.tax.non_tax') }}</option>
                                                    <option value="auto"
                                                        {{ old('tax_id', $product->tax_id) == 'auto' ? 'selected' : '' }}>
                                                        {{ sc_language_render('admin.tax.auto') }}</option>
                                                    @foreach ($taxs as $k => $v)
                                                        <option value="{{ $k }}"
                                                ...
                                                <div class="input-group-append">
                                                    <a target=_new href="{{ sc_route_admin('admin_tax.index') }}"
                                                        class="btn  btn-flat" title="New">
                                                        <i class="fa fa-plus"
                            ...
                            @if (sc_config_admin('product_promotion'))
                                {{-- price promotion --}}
                                <div
                                    class="form-group row kind kind0 kind1  {{ $errors->has('price_promotion') ? ' text-red' : '' }}">
                                    <label for="price"
                                            ...
                                            <div class="price_promotion">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" step="0.01" style="width: 100px;"
                                                        id="price_promotion" name="price_promotion"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" style="width: 100px;"
                                                            id="price_promotion_start" name="price_promotion_start"
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" style="width: 100px;"
                                                            id="price_promotion_end" name="price_promotion_end"
                        ...
                        @if (sc_config_admin('product_stock'))
                            ...
                            @if ($product->kind == SC_PRODUCT_SINGLE || $product->kind == SC_PRODUCT_BUILD)
                                <div class="form-group row {{ $errors->has('stock') ? ' text-red' : '' }}">
                                    <label for="stock"
                                        class="col-sm-2 col-form-label">{{ sc_language_render('product.stock') }}</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        @if (sc_config_admin('product_weight'))
                            ...
                            @if ($product->kind == SC_PRODUCT_SINGLE || $product->kind == SC_PRODUCT_BUILD)
                                <div class="form-group row {{ $errors->has('weight_class') ? ' text-red' : '' }}">
                                    <label for="weight_class"
                                        class="col-sm-2 col-form-label">{{ sc_language_render('product.admin.weight_class') }}</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <select class="form-control weight_class select2" name="weight_class">
                                                <option value="">
                                                    {{ sc_language_render('product.admin.select_weight') }}
                                                <option>
                            ...
                            <div class="input-group-append">
                                <a target=_new href="{{ sc_route_admin('admin_weight_unit.index') }}"
                                    class="btn  btn-flat" title="New">
                                    <i class="fa fa-plus" title="{{ sc_language_render('action.add') }}"></i>
                                </a>
                            </div>
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    ...
                    <input type="number" step="0.01" style="width: 100px;" id="weight" name="weight"
                        value="{!! old('weight', $product->weight) !!}" class="form-control weight" placeholder="" />
                </div>
        ...
        @if (sc_config_admin('product_length'))
            ...
            @if ($product->kind == SC_PRODUCT_SINGLE || $product->kind == SC_PRODUCT_BUILD)
                <div class="form-group row {{ $errors->has('length_class') ? ' text-red' : '' }}">
                    <label for="length_class"
                        class="col-sm-2 col-form-label">{{ sc_language_render('product.admin.length_class') }}</label>
                    <div class="col-sm-8">
                        <div class="input-group">
                            <select class="form-control length_class select2" name="length_class">
                                <option value="">{{ sc_language_render('product.admin.select_length') }}
                                <option>
            ...
            <div class="input-group-append">
                <a target=_new href="{{ sc_route_admin('admin_length_unit.index') }}" class="btn  btn-flat"
                    title="New">
                    <i class="fa fa-plus" title="{{ sc_language_render('action.add') }}"></i>
                </a>
            </div>
        ...
        <div class="col-sm-8">
            <div class="input-group">
                ...
                <input type="number" step="0.01" style="width: 100px;" id="length" name="length"
                    value="{!! old('length', $product->length) !!}" class="form-control length" placeholder="" />
            </div>
        ...
        <div class="col-sm-8">
            <div class="input-group">
                ...
                <input type="number" step="0.01" style="width: 100px;" id="height" name="height"
                    value="{!! old('height', $product->height) !!}" class="form-control height" placeholder="" />
            </div>
        ...
        <div class="col-sm-8">
            <div class="input-group">
                ...
                <input type="number" step="0.01" style="width: 100px;" id="width" name="width"
                    value="{!! old('width', $product->width) !!}" class="form-control width" placeholder="" />
            </div>
            @if ($errors->has('width'))
                <span class="form-text">
    ...
    @if (sc_config_admin('product_property'))
        ...
        @if ($product->kind == SC_PRODUCT_SINGLE)
            <div class="form-group row kind kind0 kind1  {{ $errors->has('property') ? ' text-red' : '' }}">
                <label for="property"
                    class="col-sm-2 col-form-label">{{ sc_language_render('product.property') }}</label>
                <div class="col-sm-8">
                    @foreach ($properties as $key => $property)
                        <div class="icheck-primary d-inline">
                            <input type="radio" id="radioPrimary{{ $key }}" name="property"
                                value="{{ $key }}"
                                {{ old('property', $product->property) == $key ? 'checked' : '' }}>
                    ...
                    <div class="input-group"
                        ...
                        <input type="text" name="download_path"
                            ...
                            placeholder="{{ sc_language_render('product.download_path') }}" />
                    </div>
    ...
    @if (sc_config_admin('product_available'))
        {{-- Date vailalable --}}
        @if ($product->kind == SC_PRODUCT_SINGLE || $product->kind == SC_PRODUCT_BUILD)
            <div class="form-group row kind kind0 kind1  {{ $errors->has('date_available') ? ' text-red' : '' }}">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                        ...
                        <input type="text" style="width: 100px;" id="date_available" name="date_available"
                            value="{!! old('date_available', $product->date_available) !!}" class="form-control date_available date_time"
                            data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" />
                    </div>
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    ...
                    <input type="number" style="width: 100px;" id="minimum" name="minimum"
                        value="{!! old('minimum', $product['minimum']) !!}" class="form-control minimum" placeholder="" />
                </div>
        ...
        <div class="col-sm-8">
            <div class="input-group">
                ...
                <input type="number" style="width: 100px;" id="sort" name="sort"
                    value="{!! old('sort', $product['sort']) !!}" class="form-control sort" placeholder="" />
            </div>
            @if ($errors->has('sort'))
                <span class="form-text">
    ...
    <div class="form-group row ">
        ...
        <div class="col-sm-8">
            <input class="checkbox" type="checkbox" name="approve"
                {{ old('approve', $product['approve']) ? 'checked' : '' }}>
        </div>
    </div>
    {{-- //Approve --}}
    ...
    <div class="form-group row ">
        ...
        <div class="col-sm-8">
            <input class="checkbox" type="checkbox" name="precio_de_cuota"
                {{ old('precio_de_cuota', $product['precio_de_cuota']) ? 'checked' : '' }}>
        </div>
    </div>
    {{-- //precio_de_cuota --}}
                    ...
                    @if ($listBuilds)
                        @foreach ($listBuilds as $key => $pID)
                            @if ($pID && $listBuildsQty[$key])
                                @php
                                    $newHtml = str_replace('value="' . $pID . '"', 'value="' . $pID . '" selected', $htmlSelectBuild);
    ...
    @if (sc_config_admin('product_attribute'))
        @if ($product->kind == SC_PRODUCT_SINGLE)
            ...
            @if (!empty($attributeGroup))
                <div class="form-group row">
                    <div class="col-sm-2">
                        <label>{{ sc_language_render('product.attribute') }} (<a
                                href="{{ sc_route_admin('admin_attribute_group.index') }}"><i class="fa fa-plus"
    ...
    @if (isset($customFields) && count($customFields))
        ...
        @endphp
        <hr class="kind ">
        <label>{{ sc_language_render('admin.custom_field.title') }} (<a target=_new
                href="{{ sc_route_admin('admin_custom_field.index') }}"><i class="fa fa-plus"
                    aria-hidden="true"></i></a>)</label>
                            ...
                            @foreach ($default as $key => $name)
                                <div class="icheck-primary d-inline">
                                    <input type="radio" id="{{ $keyField . '__' . $key }}"
                                        name="fields[{{ $field->code }}]" value="{{ $key }}"
                                        {{ old('fields.' . $field->code, $fields[$field->code]['text'] ?? '') == $key ? 'checked' : '' }}>
                    ...
                    @elseif($field->option == 'select')
                        @if ($default)
                            <select class="form-control input-sm {{ $field->code }}" style="width: 100%;"
                                ...
                                @foreach ($default as $key => $name)
                                    <option value="{{ $key }}"
                                        {{ old('fields.' . $field->code, $fields[$field->code]['text'] ?? '') == $key ? 'selected' : '' }}>
                                        {{ $name }}
                                    </option>
                                @endforeach
                            </select>
    ...
    <div class="">
        ...
        <div class="form-group row kind kind0 kind1   ">
            ...
            <div class="col-md-8">
                <div class="input-group">
                    <input type="number" id="coutas" name="coutas" value="" class="form-control nro_coutas"
        ...
        <div class="form-group row kind kind0 kind1 text-center  ">
            <div class="col-md-12">
                <button type="button" class="btn  btn-success add_attributes">
                ...
                <table class="table">
                    ...
                    @foreach ($datos_produtos as $v)
                        <tbody>
                            ...
                            <td><span onclick="deleteItem('{{ $v->id_producto }}','{{ $v->id }}');"
                                    title="Borrar" class="btn btn-flat btn-sm btn-danger"><i
    ...
    <script type="text/javascript">
        ...
        $('#add_sub_image').click(function(event) {
            ...
            $(this).before(
                '<div class="group-image">' +
                '<div class="input-group">' +
                '  <input type="text" id="sub_image_' + id_sub_image +
                '" name="sub_image[]" value="" class="form-control sub_image" placeholder=""  />' +
                '  <div class="input-group-append">' +
                '  <span data-input="sub_image_' + id_sub_image + '" data-preview="preview_sub_image_' +
                id_sub_image + '" data-type="product" class="btn btn-flat btn-primary lfm">' +
