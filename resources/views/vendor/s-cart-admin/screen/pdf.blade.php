...
<body class="c51 doc-content">
    <div class="container">
        ...
        <table class="c12">
            ...
            <tr class="c4">
                <td class="c15" colspan="1" rowspan="1">
                    <p class="c5"><span class="c3">Apellidos:  &nbsp;{{$dato_usuario['last_name']}} </span></p>
                </td>
                <td class="c9 c22" colspan="1" rowspan="1">
                    <p class="c5"><span class="c3"> Tlf.Movil: {{$dato_usuario['phone']}}&nbsp;</span></p>
                </td>
            ...
            <tr class="c4">
                <td class="c41" colspan="3" rowspan="1">
                    <p class="c30"><span class="c2">&nbsp; &nbsp; Direcci&oacute;n de Habitaci&oacute;n:{{$dato_usuario['address1']}}</span></p>
                </td>
            </tr>
            <tr class="c4">
                <td class="c15" colspan="1" rowspan="1">
                    <p class="c5"><span class="c3">Estado: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            &nbsp; &nbsp; &nbsp; &nbsp; Municipio:ciudad</span></p>
                </td>
                <td class="c9 c22" colspan="1" rowspan="1">
                    <p class="c5"><span class="c3">Parroquia: Zulia</span></p>
                </td>
                <td class="c6" colspan="1" rowspan="1">
                    <p class="c5"><span class="c3">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            &nbsp; &nbsp; &nbsp; &nbsp; Ciudad: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            ...
            <tr class="c4">
                <td class="c41" colspan="3" rowspan="1">
                    <p class="c5"><span class="c3">Ubicaci&oacute;n:</span></p>
                </td>
            </tr>
            <tr class="c24">
                <td class="c15" colspan="1" rowspan="1">
        ...
        <table class="c12">
            <tr class="c4">
                <td class="c31" colspan="1" rowspan="1">
                    <p class="c5"><span class="c3">Raz&oacute;n Social:{{$dato_usuario['razon_social']}}</span></p>
                </td>
                <td class="c9" colspan="1" rowspan="1">
                    <p class="c5"><span class="c3"> Rif: &nbsp; &nbsp; {{$dato_usuario['rif']}} &nbsp; &nbsp; &nbsp;
                            &nbsp; &nbsp; &nbsp;</span></p>
                </td>
            ...
            <tr class="c4">
                <td class="c31" colspan="1" rowspan="1">
                    <p class="c5"><span class="">V- &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;E -</span><span
                            style=""
                                title=""></span>
                        <span
                           ></span>
                ...
                <td class="c9" colspan="1" rowspan="1">
                    <p class="c5"><span class="">&nbsp;{{$dato_usuario['cedula']}}</span></p>
                </td>
                <td class="c45" colspan="1" rowspan="1">
                    <p class="c5"><span class="">Cargo:</span></p>
                </td>
            </tr>
            <tr class="c4">
                <td class="c15" colspan="1" rowspan="1">
...
<table class="c121">
        ...
        <tr class="c4">
            <td class="c43" colspan="2" rowspan="1">
                <p class="c5"><span class="">Cantidad: &nbsp; &nbsp; &nbsp; &nbsp; Descripci&oacute;n:
                        &nbsp; &nbsp;</span></p>
            </td>
