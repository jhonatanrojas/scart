                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row{{ $errors->has('natural_jurídica') ? ' has-error' : '' }}">
                            <label for="natural_jurídica"
                                    class="col-sm-2 col-form-label title2">Persona</label>
                            <div class="col-sm-8">
                            ...
                            <div class="form-group row {{ $errors->has('address2') ? ' text-red' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <textarea placeholder="Direccion 2" required  class="form-control" name="address2" id="address2" cols="30" rows="3">{{ old('address2', $customer['address2'] ?? '') }}</textarea>
                                    </div>
