                ...
                <div class="card shadow-lg" style="border-radius: 1rem;">
                  <div class="card-body p-5 text-center">
                    ...
                    <div class="row align-items-center flex-column">
                        ...
                        <form action="{{ sc_route('postLogin') }}" method="post" class="row g-3">
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group d-grid">
                                <button type="submit " name="SubmitLogin" class="btn btn-primary">{{ sc_language_render('front.login') }}</button>
                            </div>
                        ...
                        @if (empty(sc_config('LoginSocialite')))
                            ...
                            <div class="row justify-content-between mt-3">
                                <div class="col">
                                    <a target="blanck" href="https://www.instagram.com/waikaimport/"  class="btn btn-link btn-floating mx-1" type="submit">
                                        <i class="fa-brands fa-instagram fs-4"></i>
                                    </a>
                                </div>

                                <div class="col">
                                    <a href="https://www.facebook.com/people/Waikaimport-CA/100080342899840/" class="btn btn-link btn-floating mx-1" type="submit">
