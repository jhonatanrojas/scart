...
Route::group(['prefix' => 'customer'], function () use ($nameSpaceAdminCustomer) {
    ...
    Route::post('/editar_referencia', $nameSpaceAdminCustomer . '\AdminCustomerController@editar_referencia')->name('editar_referencia');
...
Route::get('/usd-exchange-rate', [DollarExchangeController::class, 'getUsdExchangeRate']);
Route::get('/actualizaTasa', [DollarExchangeController::class, 'actualizaTasa']);
